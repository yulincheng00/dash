...
def initialize():
    global posts, num, first, current_db, selected_fields, add_next_click, all_fields, fields_num, agent_pi_ip , agent_pc_ip, hidsdirpath, nidsdirpath, agent_pi_id , agent_pc_id
    # 需要 sudo 密碼以存取檔案
    today = date.today()
    agent_pc_id = "000"
    agent_pi_id = "001"
